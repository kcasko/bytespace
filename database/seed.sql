...
CREATE INDEX IF NOT EXISTS dm_conversations_user_one_idx ON dm_conversations(user_one_id, updated_at DESC);
CREATE INDEX IF NOT EXISTS dm_conversations_user_two_idx ON dm_conversations(user_two_id, updated_at DESC);
CREATE INDEX IF NOT EXISTS dm_messages_conversation_created_idx ON dm_messages(conversation_id, created_at DESC);
